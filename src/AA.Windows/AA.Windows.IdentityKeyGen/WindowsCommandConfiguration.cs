...
namespace AA.Windows.IdentityKeyGen
{
	...
	{
		public WindowsCommandConfiguration Configuration { get; set; }
	...
	public sealed class OptionAttribute : Attribute
	{
		...
		private void Add(WindowsCommandConfiguration configuration, PropertyInfo property, string value)
		{
		}

		public void AddOption(PropertyInfo property, WindowsCommandConfiguration configuration, OptionSet optionSet)
		{
	...
	public sealed class WindowsCommandConfiguration
	{
		...
		[Option("I|import",
			"encrypt .pfx key and plate it under .../AppData/Roaming/BlackRidge Technology/identities folder", IsToggle = true
		)]
		...
		private WindowsCommandConfiguration()
		{
		...
		public static bool TryCreate(string[] args, out WindowsCommandConfiguration commandConfiguration)
		{
			commandConfiguration = new WindowsCommandConfiguration();
		...
		private static void GetOptions(WindowsCommandConfiguration configuration, OptionSet options)
		{
			Type type = typeof(WindowsCommandConfiguration);
